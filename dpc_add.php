                    ...
                    <form name="form1" id="form1" action="dpc_proc.php" method="POST">
                        <table class="table table-bordered table-condensed table-striped" width="100%">
                            <tr>
                                ...
                                <td><input type="text"  name="id" class="span1" readonly="readonly" value="AUTO"></td>
                            </tr>
                            <tr>
                                <td>Nama Bupati/Walikota</td>
                                <td><input type="text" id="nama_walikota" name="nama_walikota" class="span3"></td>
                            </tr>
                            <tr>
                                <td>Nama Wakil</td>
                                <td><input type="text" name="nama_wakil" class="span3"></td>
                            </tr>
                            <tr>
                                <td>Nama Ketua DPRD</td>
                                <td><input type="text" name="nama_dprd" class="span3"></td>
                            </tr>
                            <tr>
                                <td>Partai Bupati/Walikota</td>
                                <td><input type="text" name="partai_walikota" class="span2"></td>
                            </tr>
                            <tr>
                                <td>Partai Wakil</td>
                                <td><input type="text" name="partai_wakil" class="span2"></td>
                            </tr>
                            <tr>
                                <td>Partai DPRD</td>
                                <td><input type="text" name="partai_dprd" class="span2"></td>
                            </tr>
                            <tr>
                                <td>Nama Kab/Kota</td>
                            ...
                            <tr>
                                <td>Jml Kecamatan</td>
                                <td><input type="text" name="jml_kecamatan" class="span1"></td>
                            </tr>
                            <tr>
                                <td>Tahun Pilkada</td>
                                <td><input type="text" name="thn_pilkada" class="span1"></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>
