                ...
                <div class="span12">
                    <form name="form1" id="form1" action="pac_proc.php" method="POST">
                        <table class="table table-bordered table-condensed table-striped" width="100%">
                            ...
                            <tr>
                                <td>Kecamatan</td>
                                <td><input type="text" id="kecamatan" name="kecamatan" class="span2"></td>
                            </tr>
                            <tr>
                                <td>Jumlah Desa</td>
                                <td><input type="text" name="jml_desa" class="span1"></td>
                            </tr>
                            <tr>
                                <td>Jumlah Kelurahan</td>
                                <td><input type="text" name="jml_kelurahan" class="span1"></td>
                            </tr>
                            <tr>
                                <td>Jumlah Ranting</td>
                                <td><input type="text" name="jml_ranting" class="span1"></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>
