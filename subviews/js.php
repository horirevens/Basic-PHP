...
<script src="includes/js/jquery.validationEngine.js"></script>
<script src="includes/js/jquery.validationEngine-en.js"></script>
<script src="includes/js/jquery.ui.core.js"></script>
<script src="includes/js/jquery.ui.datepicker.js"></script>
<script src="includes/js/jquery-ui-1.8.10.custom.min.js"></script>
<!--<script src="includes/jquery.tablesorter/jquery-latest.js"></script>
